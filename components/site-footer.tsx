...
export function SiteFooter() {
  return <footer className="practice-footer">
    <div><Link href="/" className="practice-logo footer-logo"><span>UDC</span><div><strong>Urgent Dental Care</strong><small>Troy, Michigan</small></div></Link><p>Prompt dental care from a familiar local office.</p></div>
